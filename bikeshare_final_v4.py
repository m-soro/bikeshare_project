{
  ...
  "metadata": {
    "colab": {
      "name": "bikeshare_final_v4.ipynb",
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyN5U1xMg1UIRDzKDdfN9wkL",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/m-soro/bikeshare_project/blob/main/bikeshare_final_v4.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
